...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nombre === '') {
        ...
        try {
            $areaModel->crear($nombre, $descripcion !== '' ? $descripcion : null);
    ...
    <div class="container mt-5">
        <div class="container-fluid mb-4">
            <div class="row align-items-center">
                <div class="col">
                    <h1>Agregar Área de formación</h1>
                </div>
                <div class="col-auto">
        ...
        <form method="post" class="card p-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="descripcion" class="form-control" rows="5" style="resize: vertical;"></textarea>
            </div>
            <div class="text-end">
