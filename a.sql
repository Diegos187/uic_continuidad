...
CREATE TABLE atributos (
  ...
  PRIMARY KEY (id),
  KEY carrera_id (carrera_id),
  CONSTRAINT atributos_ibfk_1 FOREIGN KEY (carrera_id) REFERENCES carreras (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE areas_formacion (
  ...
  PRIMARY KEY (id),
  KEY carrera_id (carrera_id),
  CONSTRAINT areas_formacion_ibfk_1 FOREIGN KEY (carrera_id) REFERENCES carreras (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE dominios (
  ...
  PRIMARY KEY (id),
  KEY carrera_id (carrera_id),
  CONSTRAINT dominios_ibfk_1 FOREIGN KEY (carrera_id) REFERENCES carreras (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE competencias (
  ...
  descripcion TEXT NOT NULL,
  tipo ENUM('Genérica','Específica') NOT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (id),
  KEY dominio_id (dominio_id),
  CONSTRAINT competencias_ibfk_1 FOREIGN KEY (dominio_id) REFERENCES dominios (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- --------------------------------------------------------
-- Tabla extendida: matrices_coherencia
-- --------------------------------------------------------
